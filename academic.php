				...
				<!-- Nav -->
					<nav id="nav">
						...
						<li ><a href="index.php">Overview</a></li>
							...
							<li><a class="active">Academic</a></li>
						</ul>
						<ul class="icons">
						...
						<!-- Post -->
							<section class="post">
								<header class="major">
									<h1>Academics<br />
							Programs</h1>
									<p>We offer best education in the universe!</p>
								</header>
								
								<h2>Wild School of Computer Science</h2>
								<h3>Bachelor of Science in League of Legends</h3>
								...
								<br><br>
								<h3>Bachelor of Science in OverWatch</h3>
								...
								<br><br>
								<h3>Bachelor of Science in PlayerUnknown's Battlegrounds</h3>
								...
								<br><br><br>
								<h2>Chicken School of Engineering</h2>
								<h3>TBA</h3>
